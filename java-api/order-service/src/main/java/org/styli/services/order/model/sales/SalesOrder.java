...
public class SalesOrder implements Serializable {
  ...
  @Column(name = "cash_on_delivery_fee")
  private BigDecimal cashOnDeliveryFee;

  @Column(name = "base_cash_on_delivery_fee")
  private BigDecimal baseCashOnDeliveryFee;
  ...
  @Column(name = "cancellation_reason_id", columnDefinition = "SMALLINT")
  ...
  private Integer payfortAuthorized;
  
  @Column(name = "authorization_capture", columnDefinition = "SMALLINT")
  private Integer authorizationCapture;

  @Column(name = "split_config_value")
  private String splitConfigValue;

  @Column(name = "is_club_shipment", columnDefinition = "SMALLINT")
  private Integer isClubShipment = 0;
  ...
  @Column(name = "global_shipping_amount")
  private BigDecimal globalShippingAmount;

  @Column(name = "base_global_shipping_amount")
  private BigDecimal baseGlobalShippingAmount;

  @Column(name = "global_cash_on_delivery_fee")
  private BigDecimal globalCashOnDeliveryFee;

  @Column(name = "base_global_cash_on_delivery_fee")
  private BigDecimal baseGlobalCashOnDeliveryFee;

  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @OrderBy
  private Set<SplitSalesOrder> splitSalesOrders = new HashSet<>();
  ...
  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @OrderBy
  private Set<SalesOrderProductDetails> salesOrderProductDetails = new HashSet<>();

  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @OrderBy
  private Set<SalesOrderAddress> salesOrderAddress = new HashSet<>();

  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @OrderBy
  private Set<SalesOrderPayment> salesOrderPayment = new HashSet<>();

  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
  @OrderBy
  private Set<SalesOrderStatusHistory> salesOrderStatusHistory = new HashSet<>();
  ...
  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
  @OrderBy
  private Set<SalesShipment> salesShipments = new HashSet<>();

  @OneToMany(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @OrderBy
  private Set<SalesOrderAddress> orderAddress = new HashSet<>();

  @OneToOne(mappedBy = "salesOrder", fetch = FetchType.LAZY, cascade = CascadeType.ALL, orphanRemoval = true)
  @OrderBy
  private SubSalesOrder subSalesOrder = new SubSalesOrder();
  ...
  public void addSplitSellerOrder(SplitSellerOrder splitSellerOrderVal) {
    ...
    splitSellerOrderVal.setSalesOrder(this);
  ...
  @Column(name = "gift_voucher_discount")
  ...
  public void addSalesOrderItem(SalesOrderItem salesOrderItemVal) {
    if (salesOrderItemVal == null) {
      return;
    }
    salesOrderItemVal.setSalesOrder(this);
    if (salesOrderItem == null) {
      salesOrderItem = new HashSet<>();
      salesOrderItem.add(salesOrderItemVal);
    } else if (!salesOrderItem.contains(salesOrderItemVal)) {
      salesOrderItem.add(salesOrderItemVal);
    }
  }
  ...
  /**
   *
   * @param salesOrderProductDetailsVal SalesOrderProductDetails
   */
  public void addSalesOrderProductDetails(SalesOrderProductDetails salesOrderProductDetailsVal) {
    if (salesOrderProductDetailsVal == null) {
      return;
    }
    salesOrderProductDetailsVal.setSalesOrder(this);
    if (salesOrderProductDetails == null) {
      salesOrderProductDetails = new HashSet<>();
      salesOrderProductDetails.add(salesOrderProductDetailsVal);
    } else if (!salesOrderProductDetails.contains(salesOrderProductDetailsVal)) {
      salesOrderProductDetails.add(salesOrderProductDetailsVal);
    }
  }

  public void addOrderAddress(SalesOrderAddress orderAddressVal) {
    if (orderAddressVal == null) {
      return;
    }
    orderAddressVal.setSalesOrder(this);
    if (orderAddress == null) {
      orderAddress = new HashSet<>();
      orderAddress.add(orderAddressVal);
    } else if (!orderAddress.contains(orderAddressVal)) {
      orderAddress.add(orderAddressVal);
    }
  }

  public void addOrderPayment(SalesOrderPayment orderPaymentVal) {
    if (orderPaymentVal == null) {
      return;
    }
    orderPaymentVal.setSalesOrder(this);
    if (salesOrderPayment == null) {
      salesOrderPayment = new HashSet<>();
      salesOrderPayment.add(orderPaymentVal);
    } else if (!salesOrderPayment.contains(orderPaymentVal)) {
      salesOrderPayment.add(orderPaymentVal);
    }
  }
  ...
  public void addSubSalesOrderItem(SubSalesOrderItem SubSalesOrderItemVal) {
	    ...
	    SubSalesOrderItemVal.setSalesOrder(this);
  ...
  public void addSalesInvoice(SalesInvoice salesInvoiceVal) {
	    ...
	    salesInvoiceVal.setSalesOrder(this);
	    if (salesInvoices == null) {
	    	salesInvoices = new HashSet<>();
	    	salesInvoices.add(salesInvoiceVal);
	    } else if (!salesInvoices.contains(salesInvoiceVal)) {
	    	salesInvoices.add(salesInvoiceVal);
	    }
	  }
}